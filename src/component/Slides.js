...
function Slides(props) {
    return(
      ...
      className="swiperPage rel"
    >
      <SwiperSlide>
        <Main mainid="mainBefore" oc="onone"/>
        <Main mainid="main" />
      </SwiperSlide>
      ...
      <div className="mainCateDiv col-md-6 position-fixed left-0 top-0 bottom-0 d-flex justify-content-start flex-column zup w-auto">
